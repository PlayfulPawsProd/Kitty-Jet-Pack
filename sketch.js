...
function setup() {
  ...
  if (storedHighScore) { highScore = int(storedHighScore); console.log("Loaded High Score:", highScore); } else { console.log("No high score found yet!"); }
